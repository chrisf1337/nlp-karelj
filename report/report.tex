...
\usepackage{times}
\usepackage{url}
\usepackage{latexsym,graphicx,listings,hyperref,booktabs}
...
\resizebox{\columnwidth}{!}{%
    \begin{tabular}{ccc}
    \toprule
    Test type & \multicolumn{1}{p{3cm}}{\centering Number of passing tests} & \multicolumn{1}{p{3cm}}{\centering Total number of tests} \\ \midrule
