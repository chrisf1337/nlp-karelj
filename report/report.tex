...
walls between grid coordinates. After running the compiled Java program in the Java Karel simulator
provided by~\newcite{Bergin:2013aa}, we obtain the final world state and compare it to the expected
