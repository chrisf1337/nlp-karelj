...
\usepackage{times}
\usepackage{url}
\usepackage{latexsym,graphicx,listings,hyperref,booktabs,array}
...
% \resizebox{\textwidth}{!}{%
    \begin{tabular}{lccc}
    \toprule
    Test type & \multicolumn{1}{p{2cm}}{\centering Number of passing tests} & \multicolumn{1}{p{3cm}}{\centering Total number of tests} & \multicolumn{1}{p{2cm}}{\centering Accuracy (\%)}\\ \midrule
